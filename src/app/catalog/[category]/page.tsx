  ...
  const mockProducts = [
    {
      ...
      image: undefined,
      tags: [{ label: "New", theme: "popular" as const }],
      ...
      price: 2990,
      originalPrice: 3990,
      currency: { symbol: "₽", position: "suffix" as const },
      rating: 4,
      reviews: 12,
      available: true,
    },
    {
      ...
      image: undefined,
      tags: [{ label: "Sale", theme: "on-sale" as const }],
    ...
    },
    {
      ...
      image: undefined,
      tags: [{ label: "Popular", theme: "popular" as const }],
      label: "Sport Line",
    ...
    },
    {
      ...
      image: undefined,
      tags: [{ label: "Eco", theme: "eco" as const }],
      label: "Accessories",
      title: "Кожаная сумка",
  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:py-10">
      <div className="mb-6 lg:mb-10">
        ...
        <p className="small-regular mt-2" style={{ color: "var(--color-neutral-dark)" }}>
